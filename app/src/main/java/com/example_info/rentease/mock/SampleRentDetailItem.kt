...
val sampleRentDetailItems = listOf(
    RentDetailItem(
        id = 1L,
        ...
        description ="စျေးနီး ကျောင်းနီး မှတ်တိုင်နီးပါတယ်\n" +
                "သွားရလာရလွယ်ကူသော နေရာမှာ ရှိပါတယ်".trimIndent(),
        totalRating = 10,
        ratingList = listOf("", "", ""),
